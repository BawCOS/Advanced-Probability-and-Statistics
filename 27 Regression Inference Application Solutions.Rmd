---
title: "Regression Inference Applications Solutions"
author:
- Lt Col Ken Horton
...
Intercept: Students who don't have any beer are expected to have a blood alcohol content of -0.0127. This value can be interpreted as how much BAC drops in the time between drinking the beers and when BAC is measured.
...
We are 95% confident that the true value of the slope is between 0.012 and 0.023. This interval does not contain 0, so it appears that number of beers and BAC are linearly related. 
