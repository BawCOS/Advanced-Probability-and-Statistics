...
$$
\Prob\left(-t_{\alpha/2,n-2} \leq {\hat{\beta}_1-\beta_1 \over {\hat \sigma \over \sqrt{ \sum (x_i-\bar{x})^2}}}\leq t_{\alpha/2,n-2} \right) = 1-\alpha
$$
...
```
We are 90\% confident the next Starbuck's menu item that has 70 grams of carbs will have a calorie content between 313.7 and 579.9.
