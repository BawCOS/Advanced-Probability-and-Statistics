...
Figure 2 is a plot of the likelihood function as a function of the unknown parameter $\pi$.
...
By visual inspection, the value of $\pi$ that makes our data most likely, maximizes the likelihood function, is something a little less than 0.4.
...
When obtaining MLEs, there are times when analytical methods (calculus) are not feasible or not possible. In Pruim 2011, there is a good example regarding data from Old Faithful at Yellowstone National Park. We need to load the `fastR2` package for this example. 
