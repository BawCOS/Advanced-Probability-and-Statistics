---
title: "Named Continuous Distribution Application Solutions"
author:
- Lt Col Ken Horton
...
d) Find the probability that at least 7 minutes will pass before the next arrival, given that 2 minute have already passed. Compare this answer to part (b). This is an example of the memoryless property of the exponential distribution.
$$
...
$$
\Prob(X>450|X>x_{0.9})=\frac{\Prob(X>450, X>x_{0.9})}{\Prob(X>x_{0.9})}=\frac{\Prob(X>450)}{0.1}
$$
