...
>**Exercise**  
Create summaries of the first 10 variables in the data. We just don't want a large printou.
...
ggplot(hfi,aes(x=pf_expression_control,y=pf_score))+
  ...
  labs(title="Personal freedom score versus Expression control",
          ...
          y="Personal freedom score")
```
The relationship does look linear. I would be uncomfortable using the model at the end points. 
