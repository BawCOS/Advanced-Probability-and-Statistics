...
Let's look at an example of confounding visually. Using the `SAT` data from the `mosaic` package let's look at expenditure per pupil versus SAT scores.

> **Exercise**:    
What conclusion to you reach from this plot?^[It appears that average SAT score declines as expenditures per student increases.]
...
fewer than 40% of students take the SAT:
