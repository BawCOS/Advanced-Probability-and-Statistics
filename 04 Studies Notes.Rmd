...
Almost all statistical methods are based on the notion of implied randomness. If observational data are not collected in a random framework from a population, results from these statistical methods are not reliable. Here we consider three random sampling techniques: simple, stratified, and cluster sampling. Figures 3, 4, and 5  provides a graphical representation of these techniques.

```{r echo=FALSE,message=FALSE,fig.cap="Examples of simple random, stratified, and cluster sampling. In this figure, simple random sampling was used to randomly select the 18 cases."}
...
```{r echo=FALSE,message=FALSE,fig.cap="In this figure, stratified sampling was used: cases were grouped into strata, and then simple random sampling was employed within each stratum."}
...
```{r echo=FALSE,message=FALSE,fig.cap="In this figure, cluster sampling was used, where data were binned into nine clusters, and three of the clusters were randomly selected."}
