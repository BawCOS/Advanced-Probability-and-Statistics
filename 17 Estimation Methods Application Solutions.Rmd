...
\end{array}\right. 
$$
Figure 1 is a plot of this likelihood function and you can see that the maximum occurs at the maximum observed data point. 

```{r echo=F,fig.align='center',fig.height=2,fig.width=3,fig.cap="A graph of the likelihood function"}
