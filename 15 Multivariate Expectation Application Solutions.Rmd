...
a. Find $\E(X)$ and $\E(Y)$.  We will use the pdf found in Application 14 solution. 
...
Find $E[XY]$ so we just go through an find all 36 values of the product and multiply by the probabilities. Since the probabilities are all constant, we will take the $\frac{1}{36}$ out of the summation. Now
