...
```
We are 96\% confident the true slope is between -4.592357e-05 and 1.008748e-04.  
...
The intercept $\beta_\text{Intercept} = \mu_\text{36}$ is the average interest rate for a 36 month loan. And $\beta_\text{trem60} = \mu_\text{term60} - \mu_\text{term36}$ is the difference in average interest rates between loan length. In this case, a 60 month loan is 4.66 percentage points higher on average than a 36 month loan.
