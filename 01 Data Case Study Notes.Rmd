...
Open the file `01 Data Case Study Application.Rmd` in RStudio Cloud and start by inserting your name in the header. Code blocks have been inserted and you need to complete the code and answer the questions. When you are done, `knit` it into a pdf file.
