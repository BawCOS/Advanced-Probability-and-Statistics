...
Suppose $X \sim \textsf{Gamma}(\alpha,\lambda)$. The pdf of $X$ for various values of $\alpha$ and $\lambda$ is shown below. 
...
Some plots of normal distributions for different parameters are plotted in Figure 3.
