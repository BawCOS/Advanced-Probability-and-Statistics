---
title: "Empirical p-values Applications Solutions"
author:
- Lt Col Ken Horton
- Lt Col Kris Pruitt
...
\begin{itemize}
\item[$H_0$:] Yawning is not contagious, someone in the group yawning does not impact the percentage of the group that yawns. 
\item[$H_A$:] Yawning does have an impact, it is contagious. If someone yawns then you are more likely to yawn. 
\end{itemize}
...
The random variable is the number of control patients that yawned from a population of 16 control patients, 34 treatment patients, where a total of 14 survived.
...
We have ten observations each to 10, we will split this and make 5 have a positive difference and 5 have a negative difference. 
...
Based our data, if the true mean body temperature is 98.6, then the probability of have 86 or more subjects out 130 with temperatures below this 0.000071. This is too unlikely so we reject the hypothesis that the average body temperature is 98.6.
